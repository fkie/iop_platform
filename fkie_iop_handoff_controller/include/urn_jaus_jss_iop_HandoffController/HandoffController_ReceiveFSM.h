...
public:
    ...
    virtual void processHandoffRequestAction(RequestReleaseControl msg, Receive::Body::ReceiveRec transportData);
    virtual void processReportHandoffDecisionTimeoutAction(ReportHandoffDecisionTimeout msg, Receive::Body::ReceiveRec transportData);
    virtual void processReportHandoffRequestTimeoutAction(ReportHandoffRequestTimeout msg, Receive::Body::ReceiveRec transportData);
    virtual void removeRequestAndSendConfirmReleaseControlAction(RemoveRequestReleaseControl msg, Receive::Body::ReceiveRec transportData);
