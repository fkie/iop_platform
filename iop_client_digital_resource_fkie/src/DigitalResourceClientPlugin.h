...
#ifndef DIGITALRESOURCECLIENTPLUGIN_H
#define DIGITALRESOURCECLIENTPLUGIN_H
...
class DllExport DigitalResourceClientPlugin : public PluginInterface
{
public:
	DigitalResourceClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	DigitalResourceClient *p_my_service;
	urn_jaus_jss_iop_DigitalResourceDiscoveryClient::DigitalResourceDiscoveryClientService *p_base_service;
