...
#ifndef UNSOLICITEDHEARTBEATPLUGIN_H
#define UNSOLICITEDHEARTBEATPLUGIN_H

#include "urn_jaus_jss_iop_UnsolicitedHeartbeat/UnsolicitedHeartbeatService.h"
...
class DllExport UnsolicitedHeartbeatPlugin : public PluginInterface
{
public:
	UnsolicitedHeartbeatPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_iop_UnsolicitedHeartbeat::UnsolicitedHeartbeatService *p_my_service;
	urn_jaus_jss_core_Liveness::LivenessService *p_base_service;
