...
#ifndef DIGITALRESOURCEDISCOVERYCLIENTPLUGIN_H
#define DIGITALRESOURCEDISCOVERYCLIENTPLUGIN_H
...
class DllExport DigitalResourceDiscoveryClientPlugin : public PluginInterface
{
public:
	DigitalResourceDiscoveryClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_iop_DigitalResourceDiscoveryClient::DigitalResourceDiscoveryClientService *p_my_service;
