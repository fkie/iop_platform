...
#ifndef PLATFORMSTATEPLUGIN_1_0_H
#define PLATFORMSTATEPLUGIN_1_0_H
...
#include "urn_jaus_jss_iop_PlatformState_1_0/PlatformStateService.h"
...
class DllExport PlatformStatePlugin_1_0 : public PluginInterface
{
public:
	PlatformStatePlugin_1_0();
	...
	virtual ~PlatformStatePlugin_1_0();

	jVariableLengthString get_service_uri() { return "urn:jaus:jss:iop:PlatformState"; }
	jUnsignedByte get_version_number_major() { return 1; }
	jUnsignedByte get_version_number_minor() { return 0; }

protected:
	urn_jaus_jss_iop_PlatformState_1_0::PlatformStateService *p_my_service;
