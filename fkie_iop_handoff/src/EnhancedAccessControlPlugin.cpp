...
#include "EnhancedAccessControlPlugin.h"
...
EnhancedAccessControlPlugin::EnhancedAccessControlPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* EnhancedAccessControlPlugin::get_service()
{
	return p_my_service;
}

void EnhancedAccessControlPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new EnhancedAccessControlService(jaus_router, p_transport_service, p_events_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::EnhancedAccessControlPlugin, iop::PluginInterface)
