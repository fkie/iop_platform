...
#ifndef ENHANCEDACCESSCONTROLPLUGIN_H
#define ENHANCEDACCESSCONTROLPLUGIN_H

#include "urn_jaus_jss_iop_EnhancedAccessControl/EnhancedAccessControlService.h"
...
class DllExport EnhancedAccessControlPlugin : public PluginInterface
{
public:
	EnhancedAccessControlPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_iop_EnhancedAccessControl::EnhancedAccessControlService *p_my_service;
