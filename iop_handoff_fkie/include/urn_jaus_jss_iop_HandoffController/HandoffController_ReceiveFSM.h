...
protected:
	...
	void p_ros_handoff_request(const iop_msgs_fkie::HandoffRequest::ConstPtr msg);
	void p_ros_handoff_response(const iop_msgs_fkie::HandoffResponse::ConstPtr msg);
