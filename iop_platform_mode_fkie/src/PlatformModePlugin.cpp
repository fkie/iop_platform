...
using namespace iop;
using namespace urn_jaus_jss_iop_PlatformMode;
...
PlatformModePlugin::PlatformModePlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* PlatformModePlugin::get_service()
{
	return p_my_service;
}

void PlatformModePlugin::create_service(JTS::JausRouter* jaus_router)
{
...
PLUGINLIB_EXPORT_CLASS(iop::PlatformModePlugin, iop::PluginInterface)
