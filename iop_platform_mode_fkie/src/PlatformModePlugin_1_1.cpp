...
#include <PlatformModePlugin_1_1.h>
#include <pluginlib/class_list_macros.h>

using namespace iop;
using namespace urn_jaus_jss_iop_PlatformMode_1_1;
...
PLUGINLIB_EXPORT_CLASS(iop::PlatformModePlugin_1_1, iop::PluginInterface)
