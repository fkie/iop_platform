...
#ifndef PLATFORMMODEPLUGIN_H
#define PLATFORMMODEPLUGIN_H
...
#include "urn_jaus_jss_iop_PlatformMode/PlatformModeService.h"
...
class DllExport PlatformModePlugin : public PluginInterface
{
public:
	PlatformModePlugin();
...
protected:
	urn_jaus_jss_iop_PlatformMode::PlatformModeService *p_my_service;
