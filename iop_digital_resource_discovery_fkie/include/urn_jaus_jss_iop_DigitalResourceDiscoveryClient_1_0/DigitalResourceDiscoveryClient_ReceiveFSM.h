...
#include "urn_jaus_jss_iop_DigitalResourceDiscoveryClient_1_0/Messages/MessageSet.h"
#include "urn_jaus_jss_iop_DigitalResourceDiscoveryClient_1_0/InternalEvents/InternalEventsSet.h"
...
namespace urn_jaus_jss_iop_DigitalResourceDiscoveryClient_1_0
{

class DllExport DigitalResourceDiscoveryClient_ReceiveFSM : public JTS::StateMachine
{
public:
	DigitalResourceDiscoveryClient_ReceiveFSM(urn_jaus_jss_core_Transport_1_0::Transport_ReceiveFSM* pTransport_ReceiveFSM, urn_jaus_jss_core_EventsClient_1_0::EventsClient_ReceiveFSM* pEventsClient_ReceiveFSM);
...
protected:
	...
	bool pUpdateEndpointsSrv(iop_msgs_fkie::QueryByAddr::Request  &req, iop_msgs_fkie::QueryByAddr::Response &res);
