...
#include <DigitalResourceDiscoveryClientPlugin.h>
...
DigitalResourceDiscoveryClientPlugin::DigitalResourceDiscoveryClientPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* DigitalResourceDiscoveryClientPlugin::get_service()
{
	return p_my_service;
}

void DigitalResourceDiscoveryClientPlugin::create_service(JTS::JausRouter* jaus_router)
{
...
PLUGINLIB_EXPORT_CLASS(iop::DigitalResourceDiscoveryClientPlugin, iop::PluginInterface)
