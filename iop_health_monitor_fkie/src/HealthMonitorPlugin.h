...
#ifndef HEALTHMONITORPLUGIN_H
#define HEALTHMONITORPLUGIN_H

#include "urn_jaus_jss_core_AccessControl/AccessControlService.h"
#include "urn_jaus_jss_core_Events/EventsService.h"
#include "urn_jaus_jss_exp_aeodrs_HealthMonitor/HealthMonitorService.h"
...
class DllExport HealthMonitorPlugin : public PluginInterface
{
public:
	HealthMonitorPlugin();
...
protected:
	urn_jaus_jss_exp_aeodrs_HealthMonitor::HealthMonitorService *p_my_service;
