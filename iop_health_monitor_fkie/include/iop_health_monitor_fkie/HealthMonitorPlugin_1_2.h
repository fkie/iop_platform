...
#ifndef HEALTHMONITORPLUGIN_1_2_H
#define HEALTHMONITORPLUGIN_1_2_H

#include "urn_jaus_jss_core_AccessControl_1_0/AccessControlService.h"
#include "urn_jaus_jss_core_Events_1_0/EventsService.h"
#include "urn_jaus_jss_exp_aeodrs_HealthMonitor_1_2/HealthMonitorService.h"
...
class DllExport HealthMonitorPlugin_1_2 : public PluginInterface
{
public:
	HealthMonitorPlugin_1_2();
	...
	virtual ~HealthMonitorPlugin_1_2();

	jVariableLengthString get_service_uri() { return "urn:jaus:jss:exp:aeodrs:HealthMonitor"; }
	jUnsignedByte get_version_number_major() { return 1; }
	jUnsignedByte get_version_number_minor() { return 2; }

protected:
	urn_jaus_jss_exp_aeodrs_HealthMonitor_1_2::HealthMonitorService *p_my_service;
