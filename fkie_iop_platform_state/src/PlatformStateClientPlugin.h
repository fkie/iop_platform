...
#ifndef PLATFORMSTATECLIENTPLUGIN_H
#define PLATFORMSTATECLIENTPLUGIN_H
...
#include "urn_jaus_jss_iop_PlatformStateClient/PlatformStateClientService.h"
...
class DllExport PlatformStateClientPlugin : public PluginInterface
{
public:
	PlatformStateClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_iop_PlatformStateClient::PlatformStateClientService *p_my_service;
